...
import static com.ifreelight.dyna.AppConstants.VIEW_FIELD_FIELDS_OPERATOR;
        ...
        if (param.get("depends") != null) {
            ...
            for (Map field : fields) {
                ...
                if (f != null) {
                    ...
                    if(value!=null){
                        if(field.get(VIEW_FIELD_FIELDS_OPERATOR)!=null){
                            query.put(field.get("name"),new BasicDBObject(MapUtils.getString(field,VIEW_FIELD_FIELDS_OPERATOR),value));
                        }else {
