...
import com.github.yuebo.elfinder.util.FsItemFilterUtils;
import com.github.yuebo.elfinder.util.FsServiceUtils;
...
public abstract class AbstractCommandExecutor implements CommandExecutor
{
			...
			FsItemEx fsi) throws IOException
	{
		...
		info.put("objectId",fsi.getObjectId());
		...
		if (fsi.getMimeType().startsWith("image"))
		{
			...
			StringBuffer qs = new StringBuffer(url);
