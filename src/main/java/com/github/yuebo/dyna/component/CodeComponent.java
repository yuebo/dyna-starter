 ...
 */
@Component
public class CodeComponent implements UIComponent {
    @Override
    ...
    public List<OrderedResourse> getRequiredJS() {
        ...
        list.add(new OrderedResourse(80,"/static/resources/codemirror/codemirror.js"));
        list.add(new OrderedResourse(90,"/static/resources/codemirror/mode/javascript/javascript.js"));
        return list;
    }
}
