...
!function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$selectItem.off('click').on('click', function (event) {
            ...
            row[that.header.stateField+"_checked"] = checked;
            that.trigger(checked ? 'check' : 'uncheck', row);

            if (that.options.singleSelect) {
                that.$selectItem.not(this).each(function () {
                    that.data[$(this).data('index')][that.header.stateField+"_checked"] = false;
                });
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (that.options.sidePagination === 'server') {
                    //if the server validation is false, update the error message, else remove the error message and update the data
                    if(res.validate){
                    	if(res.clear){
                    		 $("#msgDiv").html("");
    ...
    BootstrapTable.prototype.updateRows = function (checked) {
        ...
        this.$selectItem.each(function () {
            that.data[$(this).data('index')][that.header.stateField+"_checked"] = checked;
        });
    };
    ...
    BootstrapTable.prototype.resetRows = function () {
        ...
        $.each(this.data, function (i, row) {
            ...
            row[that.header.stateField+"_checked"] = false;
        });
    };
    ...
    BootstrapTable.prototype.getSelections = function () {
        ...
        return $.grep(this.data, function (row) {
            return row[that.header.stateField+"_checked"]==true;
        });
    };
